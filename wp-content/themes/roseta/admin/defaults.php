...
function roseta_get_option_defaults() {
	...
	// Typography
	"theme_fgeneral" 			=> 'Montserrat/gfont',
	...
	"theme_fwtitle" 			=> 'Montserrat/gfont',
	"theme_fwtitlegoogle"		=> '',
	...
	"theme_fwcontent" 			=> 'Montserrat/gfont',

...
'options' => array (
	...
	'id' => 'theme_falign',
		...
		'labels' => array( __("Left Top","roseta"), __("Left Center","roseta"), __("Left Bottom","roseta"), __("Right Top","roseta"), __("Right Center","roseta"), __("Right Bottom","roseta"), __("Center Top","roseta"), __("Center Center","roseta"), __("Center Bottom","roseta") ),
		'desc' => '',
	'section' => 'theme_featured' ),
...
/* 	array(
	...
	'id' => 'theme_socials_right_sidebar',
		...
		'desc' => sprintf( __( 'Select where social icons should be visible in.<br><br><strong>Social Icons are defined using the <a href="%1$s" target="_blank">social icons menu</a></strong>. Read the <a href="%2$s" target="_blank">theme documentation</a> on how to create a social menu.', 'roseta' ), 'nav-menus.php?action=locations', 'http://www.cryoutcreations.eu/wordpress-tutorials/use-new-social-menu' ),
	'section' => 'theme_socials' ),

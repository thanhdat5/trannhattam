...
get_header(); ?>
	...
	<div class="<?php echo roseta_get_layout_class(); ?>">
		<main id="main" role="main" class="main bg-white" style="width:100%;background-color:#fff !important;">
			<div class="container">
                <?php cryout_before_content_hook(); ?>

			    <?php if ( have_posts() ) : ?>

				    <header style="display:block !important;margin-bottom:0 !important;margin-top: 20px;" class="page-header content-search pad-container" <?php cryout_schema_microdata( 'element' ); ?>>
